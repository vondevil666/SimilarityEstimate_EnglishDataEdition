        ...
        try {
            ...
            for (Row row : sheet) {
                ...
                for (Cell cell : row) {
                    ...
                    else set.add(cell.toString().trim());
                }
            ...
            e.printStackTrace();
            //FirstServlet.textAreaPrint("读取标准表失败，请选择正确的标准表文件，或关闭当前打开的标准表文件...");
        }
...
//                        cell.getStringCellValue();
            ...
            e.printStackTrace();
            //FirstServlet.textAreaPrint("读取目标表失败，请选择正确的目标表文件，或关闭当前打开的目标表文件...");
        }
